...
import {
  blocksToMarkdown as _blocksToMarkdown,
  richTextToMarkdown as _richTextToMarkdown
...
export const blocksToMarkdown = _blocksToMarkdown
export const richTextToMarkdown = _richTextToMarkdown
