...
describe('Security Utilities', () => {
  ...
  describe('wrapToolResult', () => {
    ...
    it('should sanitize XPIA opening tags, including padded ones (and JSON-escaped sequences)', () => {
      // Simulate real stringified JSON output where newlines are literal \n and \r
      ...
      // The inner opening tag should be sanitized, correctly matching JSON-escaped sequences
      expect(result).not.toContain('<untrusted_notion_content>"')
      expect(result).not.toContain('< / untrusted_notion_content>')
