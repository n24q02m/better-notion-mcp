...
describe('blocksToMarkdown', () => {
  it('should convert paragraph blocks', () => {
    const blocks = [createParagraph([createRichText('Hello world')])]
  ...
  it('should convert code blocks', () => {
    const blocks = [createCodeBlock([createRichText('console.log("Hello")')], 'typescript')]
    expect(blocksToMarkdown(blocks)).toBe('```typescript\nconsole.log("Hello")\n```')
  })

  it('should handle code blocks without language', () => {
    const blocks = [createCodeBlock([createRichText('echo "test"')])]
    expect(blocksToMarkdown(blocks)).toBe('```plain text\necho "test"\n```')
  })

  it('should convert quote blocks', () => {
    const blocks = [createQuote([createRichText('This is a quote')])]
  ...
  it('should handle links', () => {
    const blocks = [createParagraph([createRichText('Click here', {}, 'https://example.com')])]
