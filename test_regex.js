...
console.log("Original regex (real whitespace):", maliciousJsonTextWithRealWhitespace.replace(regex1, '<_/untrusted_notion_content'))
console.log("Original regex (jsonText):", jsonText.replace(regex1, '<_/untrusted_notion_content'))
console.log("New regex (real whitespace):", maliciousJsonTextWithRealWhitespace.replace(regex2, '<_/untrusted_notion_content'))
